  ...
  callback: function(answer) {
    switch (answer.action) {
      case "Show balance":
        ...
        break;
      case "Show deposit address":
        console.log("Deposit address:", wallet.getCurrentAddress());
        break;
      case "Send transaction":
        exports.askTransactionDetails();
        break;
      case "Exit":
        process.exit();
    }
...
const validate = require('./modules/bitcoin-address-validator');
